...
function JoinBanner() { return <section className="mx-4 mb-10 overflow-hidden rounded-xl border border-gold/30 bg-gradient-to-r from-gold/15 via-card to-gold/5 p-5 sm:mx-6 sm:p-7 lg:mx-8"><div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left"><img src="https://cdn.builder.io/api/v1/image/assets%2F387c17f062d04bd5837dfeec0d29ae1e%2F15e7e7802fe94776a6c1a7602e9e6c7c?format=webp&width=800&height=1200" alt="Bailey VIP access design" className="h-20 w-32 scale-110 rounded-lg object-cover blur-[12px] shadow-lg" /><div className="flex-1"><h2 className="font-display text-xl text-white">Ready for premium access?</h2><p className="mt-1 text-xs text-muted-foreground">Unlock exclusive videos, events, and premium experiences with Bailey VIP access.</p></div><Link to="/vip-membership" className="rounded-full bg-gradient-to-r from-gold-light to-gold px-5 py-3 text-[10px] font-bold uppercase tracking-wider text-black">Explore VIP Access</Link></div></section>; }
