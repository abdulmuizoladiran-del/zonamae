...
export default function VipMembership() {
  return <Layout><VipHero /><WhyVip /><Benefits /><Plans /><Compare /><Process /><AccessShowcase /><Events /><Merchandise /><Testimonials /><Faq /><Registration /><Trust /><FinalCta /></Layout>;
}
...
function AccessShowcase() {
  return <section className="container py-10 sm:py-14"><div className="grid gap-6 rounded-2xl border border-border bg-card/30 p-5 sm:p-8 md:grid-cols-2"><div><div className="flex items-center justify-between"><h2 className="font-display text-xl text-gold">VIP Access Preview</h2><span className="text-[10px] uppercase tracking-wider text-muted-foreground">Primary design</span></div><div className="mt-5"><VipAccessDesign /></div></div><div><div className="flex items-center justify-between"><h2 className="font-display text-xl text-gold">Your exclusive access</h2><span className="text-[10px] uppercase tracking-wider text-muted-foreground">Secondary design</span></div><div className="mt-5"><VipAccessDesign back /></div></div></div></section>;
}
