...
const plans = [
  { name: "Silver VIP", price: "$19.99", accent: false, items: ["Official VIP Card", "Exclusive News & Updates", "Early Ticket Access", "Priority Support"] },
  { name: "Gold VIP", price: "$49.99", accent: true, items: ["All Silver VIP Benefits", "Meet & Greet Access", "Signed Merchandise", "Birthday Message from Zona Mae", "Exclusive Videos & Photos"] },
  { name: "Platinum VIP", price: "$99.99", accent: false, items: ["All Gold VIP Benefits", "Backstage Access", "Personalized Video Message", "VIP Concierge Support", "Exclusive Invitations"] },
];
const testimonials = [
...
function Compare() {
  const rows = [["VIP Card", "✓", "✓", "✓"], ["Exclusive Content", "✓", "✓", "✓"], ["Early Ticket Access", "✓", "✓", "✓"], ["Meet & Greet", "—", "✓", "✓"], ["Backstage Access", "—", "—", "✓"], ["Signed Merchandise", "—", "✓", "✓"], ["Personalized Message", "—", "—", "✓"], ["Price / Month", "$19.99", "$49.99", "$99.99"]];
