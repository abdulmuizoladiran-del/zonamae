...
const plans = [
  { name: "Silver VIP", price: "$500", accent: false, items: ["Official Bailey VIP Access", "Exclusive News & Updates", "Early Ticket Access", "Priority Support"] },
  { name: "Gold VIP", price: "$1500", accent: true, items: ["All Silver VIP Benefits", "Meet & Greet Access", "Signed Merchandise", "Birthday Message from Bailey", "Exclusive Videos & Photos"] },
...
export default function VipMembership() {
  return <Layout><VipHero /><WhyVip /><Benefits /><Plans /><Compare /><Process /><Events /><Testimonials /><Faq /><Registration /><Trust /><FinalCta /></Layout>;
}
...
function Compare() {
  const rows = [["VIP Access", "✓", "✓", "✓"], ["Exclusive Content", "✓", "✓", "✓"], ["Early Ticket Access", "✓", "✓", "✓"], ["Meet & Greet", "—", "✓", "✓"], ["Backstage Access", "—", "—", "✓"], ["Signed Merchandise", "—", "✓", "✓"], ["Personalized Message", "—", "—", "✓"], ["Price / Month", "$500", "$1500", "$3000"]];
