...
const faqs = ["How do I become a VIP Member?", "How can I track my VIP card?", "How do I book a Meet & Greet?", "How long does support take to respond?"];
...
function Hero() { return <section className="relative overflow-hidden border-b border-border bg-noise py-14 sm:py-20"><div className="pointer-events-none absolute right-0 top-0 h-[450px] w-[450px] rounded-full bg-gold/10 blur-[130px]" /><div className="container relative grid items-center gap-10 lg:grid-cols-2"><div className="text-center lg:text-left"><p className="text-xs font-semibold uppercase tracking-[0.28em] text-gold">Contact Us</p><h1 className="mt-3 font-display text-5xl font-bold uppercase leading-[0.95] text-white sm:text-7xl">We're Here<br /><span className="text-gradient-gold">For You</span></h1><p className="mx-auto mt-5 max-w-lg text-sm leading-relaxed text-muted-foreground lg:mx-0">We’re here to assist with VIP Membership, Meet &amp; Greet reservations, VIP card tracking, partnerships, and general enquiries.</p><div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start"><a href="#contact-form" className="rounded-full bg-gradient-to-r from-gold-light to-gold px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-black transition-transform hover:scale-105">Send a Message <ArrowRight className="inline h-4 w-4" /></a><Link to="/login" className="rounded-full border border-gold/60 px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-gold hover:bg-gold/10">Member Login</Link></div></div><div className="relative mx-auto w-full max-w-md"><div className="overflow-hidden rounded-2xl border border-gold/30 shadow-2xl"><img src={heroImage} alt="Zona Mae" className="aspect-[1.15/1] w-full object-cover object-top" /><div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-black/10" /></div><div className="absolute -bottom-8 right-0 w-52 rotate-[-5deg] rounded-xl border border-gold/60 bg-gradient-to-br from-[#242016] to-[#0b0b0b] p-4 shadow-[0_0_45px_-8px_hsl(var(--gold)/0.65)] sm:-right-8"><div className="flex items-center justify-between"><span className="font-display text-xl text-gold">ZM</span><MessageCircle className="h-5 w-5 text-gold" /></div><p className="mt-4 text-[10px] uppercase tracking-widest text-gold">Official support</p><p className="mt-1 font-display text-lg text-white">We’re here for you</p></div></div></div></section>; }
